...
1. US-004 global hotkey registration and conflict handling.
2. US-006 direct paste backend abstraction and fallback UX finalization.
3. US-010 settings center baseline for shortcut/capacity/paste controls.
