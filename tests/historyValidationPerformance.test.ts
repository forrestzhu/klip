...
import { validateHistoryItem, isEmptyHistoryItem, createHistoryId } from '../src/features/history/historyUtils';
...
describe('History Utils Performance Tests', () => {
  ...
  it('should check empty items efficiently', () => {
    const items = Array.from({ length: 10000 }, (_, i) => i % 2 === 0 ? '' : `Content ${i}`);
